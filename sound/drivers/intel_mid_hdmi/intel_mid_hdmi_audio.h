...
#define MAX_CNT			0xFF
#define MAX_SZ_ZERO_BUF		(1024*1024)

/* Speaker allocation map (from CEA861) */
#define AL_TWO_ZERO		0x00
#define AL_THREE_ONE	0x05
#define AL_FIVE_ONE		0x0B
#define AL_SEVEN_ONE	0x13

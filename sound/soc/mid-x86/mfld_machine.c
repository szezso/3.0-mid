...
/* FIXME: Mic bias is different from Phone */
...
/* FIXME: jack detection voltage zones are differ from medfield phone */
...
*/	{
	...
	{
		.name = "Medfield Compressed Headset Playback",
		.stream_name = "Headset",
	...
	{
		.name = "Medfield Compressed Speaker Playback",
		.stream_name = "Speaker",
		.cpu_dai_name = "Virtual-cpu-dai",
		.codec_dai_name = "SN95031 Speaker",
		.codec_name = "sn95031",
	...
	{
		.name = "Medfield Headset Virtual",
		.stream_name = "Headset",
		.cpu_dai_name = "Headset-virtual-cpu-dai",
		.codec_dai_name = "SN95031 Headset",
		.codec_name = "sn95031",
		.platform_name = "sst-platform",
		.init = NULL,
	...
	{
		.name = "Medfield Speaker Virtual",
		.stream_name = "Speaker",
		.cpu_dai_name = "Speaker-virtual-cpu-dai",
		.codec_dai_name = "SN95031 Speaker",
		.codec_name = "sn95031",
		.platform_name = "sst-platform",
		.init = NULL,
...
static irqreturn_t snd_mfld_jack_intr_handler(int irq, void *dev)
{
	...
	/* FIXME: Jack interrupt status byte order different from phone */
	/*To retrieve the jack_interrupt_status value (MSB)*/
	mc_private->jack_interrupt_status |= 0x0F & intr_status;
	/*To retrieve the oc_interrupt_status value (LSB)*/
	mc_private->oc_interrupt_status |= 0x0F & (intr_status >> 8);
